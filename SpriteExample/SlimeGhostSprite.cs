...
namespace SpriteExample
{
    ...
    public class SlimeGhostSprite
    {
        ...
        public void Draw(GameTime gameTime, SpriteBatch spriteBatch)
        {
            ...
            spriteBatch.Draw(texture, position, null, Color.White, 0, new Vector2(64,64), 0.5f, spriteEffects, 0);  //the new vector two is the center of rotation // the .33f is how it rotates
                                                                                          //^ the size of the vector
            //spriteBatch.Draw(texture, new Rectangle((int)position.X, (int)position.Y, 60, 20), Color.White); hard scale
        }
    }
}
